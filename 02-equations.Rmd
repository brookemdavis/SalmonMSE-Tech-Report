...
```{r Natural Production Parameters, tab.cap = "Table showing random numbers."}
param_NP <- param[grepl("Natural production|Population dynamics", param$Type), ] %>% select(-Type)
flextable(param_NP) |> 
...
<!-- knitr::kable(param_hab, row.names = FALSE) -->
<!-- ``` -->
...
<!-- knitr::kable(param_hatch, row.names = FALSE) -->
<!-- ``` -->
...
<!-- knitr::kable(param_harv, row.names = FALSE) -->
<!-- ``` -->
