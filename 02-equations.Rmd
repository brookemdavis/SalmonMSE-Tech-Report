...
```{r Natural_Production_Parameters, tab.cap = "Natural production parameters"} 
...
flextable(param_NP) |> 
  ...
  #set_caption(caption = "Parameters related to natural production and population dynamics.")

```

## Habitat

```{r Habitat_Parameters, tab.cap = "Habitat parameters"}
...
```{r Hatchery_Parameters, tab.cap = "Parameters related to hatchery production"}
